...
def project_settings(root: Path) -> tuple[dict[str, Any], Path, bool]:
    ...
    defaults = {
        ...
        "content_generation": {"provider": "codemie", "model": "gpt-4.1-mini", "require_review": True},
        "vision_analysis": {"enabled": True, "provider": "codemie", "model": "gpt-4.1", "require_review": True, "max_image_bytes": 5_000_000, "max_keyframes": 8, "max_vision_images": 20},
...
def load_project(project_dir: str | Path) -> ProjectConfig:
    ...
    return ProjectConfig(
        ...
        content_generation=ContentGenerationConfig(
            provider=str(content_generation.get("provider", "openai-compatible")),
            model=str(content_generation.get("model", "gpt-4.1-mini")),
        ...
        vision=VisionConfig(
            ...
            provider=str(vision.get("provider", "openai-compatible")),
            model=str(vision.get("model", "gpt-4.1")),
